...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_CONFIG_TITLE', 'Configuration');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_CONFIG_DESC', 'For integration, select predefined configuration settings or \'Production\' for live systems');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_MASTERPASS_DESC', 'Enable payment type Masterpass?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SEPA-DD_TITLE', 'SEPA Direct Debit');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SEPA-DD_DESC', 'Enable payment type Direct Debit?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SOFORTUEBERWEISUNG_TITLE', 'Online bank transfer.');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SOFORTUEBERWEISUNG_DESC', 'Enable payment type Online bank transfer.?');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_IDL_TITLE', 'iDEAL');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_IDL_DESC', 'Enable payment type iDEAL?');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_GIROPAY_TITLE', 'giropay');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_GIROPAY_DESC', 'Enable payment type Giropay?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_TRUSTLY_DESC', 'Enable payment type Trustly?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_PRZELEWY24_DESC', 'Enable payment type Przelewy24?');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SEPA-DD_TEXT', 'SEPA Direct Debit');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_SOFORTUEBERWEISUNG_TEXT', 'Online bank transfer.');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_INVOICE_TEXT', 'Invoice');
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_PAYSYS_CCARD-MOTO_TEXT', 'Credit Card - Mail Order and Telephone Order');
...
define('MODULE_PAYMENT_WIRECARD_CHECKOUT_PAGE_BIRTHDAY_ERROR', 'You have to be 18 years or older to use this payment.');
?>